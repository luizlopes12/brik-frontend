    ...
    <div className={ popUps.taxesEdit ? style.popUpBackdrop : style.popUpDisabled }>
      <div className={style.popUpWrapper}>
        <div className={style.popUpHeader}>
          <span><img src="/images/taxesIcon.svg" />Editar juros</span>
        ...
        <li className={style.taxInputItem}>
            ...
            <div className={style.taxInputWrapper}>
              <input type="number" pattern="^(?=.)(\d{1,3}(,\d{3})*)?(\.\d+)?$"  name='defaultTax' value={taxes.defaultTax} onChange={handleChangeTax}/>%
            </div>
          </li>
          <li className={style.taxInputItem}>
            ...
            <span className={style.taxItemLine}></span>
            <div className={style.taxInputWrapper}>
              <input type="number" pattern="^(?=.)(\d{1,3}(,\d{3})*)?(\.\d+)?$"  name='after24Months' value={taxes.after24Months} onChange={handleChangeTax}/>%
            </div>
          </li>
        </ul>
