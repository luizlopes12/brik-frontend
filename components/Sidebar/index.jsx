...
const LoteamentosIconSvg = () => (
  ...
  >
    <path
      d="M6 9.83334L2 11.8333L12 16.8333L22 11.8333L18 9.83334"
      stroke="black"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M2 21.8333L12 26.8333L22 21.8333"
      stroke="black"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M2 16.8333L12 21.8333L22 16.8333"
      stroke="black"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M16 7.5736C16 10.4827 12 12.9762 12 12.9762C12 12.9762 8 10.4827 8 7.5736C8 6.58162 8.42143 5.63028 9.17157 4.92884C9.92172 4.22741 10.9391 3.83334 12 3.83334C13.0609 3.83334 14.0783 4.22741 14.8284 4.92884C15.5786 5.63028 16 6.58162 16 7.5736Z"
      stroke="black"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M12 8.82036C12.7364 8.82036 13.3333 8.26217 13.3333 7.5736C13.3333 6.88504 12.7364 6.32685 12 6.32685C11.2636 6.32685 10.6667 6.88504 10.6667 7.5736C10.6667 8.26217 11.2636 8.82036 12 8.82036Z"
      stroke="black"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const VendasIconSvg = () => (
  ...
  >
    <g clipPath="url(#clip0_181_293)">
      ...
      />
      <path
        d="M17 5.16667H9.5C8.57174 5.16667 7.6815 5.53542 7.02513 6.1918C6.36875 6.84818 6 7.73841 6 8.66667C6 9.59493 6.36875 10.4852 7.02513 11.1415C7.6815 11.7979 8.57174 12.1667 9.5 12.1667H14.5C15.4283 12.1667 16.3185 12.5354 16.9749 13.1918C17.6313 13.8482 18 14.7384 18 15.6667C18 16.5949 17.6313 17.4852 16.9749 18.1415C16.3185 18.7979 15.4283 19.1667 14.5 19.1667H6"
        stroke="black"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <defs>
      <clipPath id="clip0_181_293">
        <rect
          ...
          height="24"
          fill="white"
          transform="translate(0 0.166672)"
        />
      </clipPath>
    </defs>
  </svg>
      ...
      <nav className={style.nav}>
        <ul>
          {userPermissions.admin && (
            <li className={router.pathname == "/admin" ? style.active : null}>
              <Link href="/admin" onClick={handleShowMenu}>
                <OverviewIconSvg />
                <span className={style.navText}>Overview</span>
              </Link>
            </li>
          )}
          {userPermissions.editDivisions && (
            <li
              className={
                router.pathname == "/admin/loteamentos" ? style.active : null
              }
            >
              <Link href="/admin/loteamentos" onClick={handleShowMenu}>
                <LoteamentosIconSvg />
                <span className={style.navText}>Loteamentos</span>
              </Link>
            </li>
          )}
          <li
            className={router.pathname == "/admin/vendas" ? style.active : null}
          >
            <Link href="/admin/vendas" onClick={handleShowMenu}>
              <VendasIconSvg />
              <span className={style.navText}>Vendas</span>
            </Link>
          </li>
          {userPermissions.editBanners && (
            <li
              className={
                router.pathname == "/admin/banners" ? style.active : null
              }
            >
              <Link href="/admin/banners" onClick={handleShowMenu}>
                <BannersIconSvg />
                <span className={style.navText}>Banners</span>
              </Link>
            </li>
          )}
        </ul>
        <ul>
          <li
            className={
              router.pathname == "/admin/configs" ? style.active : null
            }
          >
            <Link href="/admin/configs" onClick={handleShowMenu}>
              <ConfigIconSvg />
              <span className={style.navText}>Permissões</span>
            </Link>
          </li>
          {/* To do: redirect to the initial page and clear user data from global state */}
          <li
            className={router.pathname == "/admin/logout" ? style.active : null}
          >
