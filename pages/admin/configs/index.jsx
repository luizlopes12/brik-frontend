              ...
              <FormControlLabel
                control={
                  <Checkbox
                    name="editDivisions"
                    checked={
                      checkboxValues.editDivisions || selectedUser.editDivisions
                    }
                    onChange={handleCheckboxChange}
                    color="success"
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    name="editPartners"
                    checked={
                      checkboxValues.editPartners || selectedUser.editPartners
                    }
                    onChange={handleCheckboxChange}
                    color="success"
                  />
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    name="editBanners"
                    checked={
                      checkboxValues.editBanners || selectedUser.editBanners
                    }
                    onChange={handleCheckboxChange}
                    color="success"
                  />
