...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    const overViewRes = await fetch(
      `${process.env.BACKEND_URL}/sales/overview`
    );
      ...
      <ul className={style.periodInfo}>
        <li className={style.lotsPeriod}>
          ...
          <span className={style.info}>
            <b>{overViewData.lots.lotsQuantity}</b>{" "}
            <label>
              Cadastros no <br />
              último mês
            </label>
        ...
        <li className={style.divisionsPeriod}>
          ...
          <span className={style.info}>
            <b>{overViewData.divisions.divisionsQuantity}</b>{" "}
            <label>
              Cadastros no <br />
              último mês
            </label>
        ...
        <li className={style.salesPeriod}>
          ...
          <span className={style.info}>
            <b>{overViewData.sales.salesQuantity}</b>{" "}
            <label>
              Cadastros no <br />
              último mês
            </label>
