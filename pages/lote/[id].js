    ...
    <section className={style.detailsContainer}>
      ...
      <div className={style.lotDetails}>
        <div className={style.lotImages} onClick={handleShowMoreImages}>
          ...
          <button
            className={style.viewMoreImagesButton}
      ...
      {viewMoreImages && (
        <>
          <button className={style.closeButton} onClick={handleShowMoreImages}>
            {" "}
            <img src="/images/closeIcon.svg" />
          </button>
          <ImagesSliderPopUp
            images={lotData.loteImages}
            closeFunction={handleShowMoreImages}
